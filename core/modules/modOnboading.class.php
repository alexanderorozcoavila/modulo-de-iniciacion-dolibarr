...
class modOnboading extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->description = "Modulo de iniciacion de dolibarr";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "Modulo de iniciacion de dolibarr.";
		...
		$this->module_parts = array(
									...
									'css' => array('/onboading/css/onboading.css','/onboading/css/modal.css','/onboading/css/style.css','/onboading/css/circle.css'),	// Set this to relative path of css file if module has its own css file
